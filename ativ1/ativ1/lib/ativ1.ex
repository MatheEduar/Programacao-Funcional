defmodule Ativ1 do
  ...
  def centraliza(str, largura) do
    espacos_total = largura - String.length(str)
    espacos_esquerda = Integer.floor_div(espacos_total, 2) + rem(espacos_total, 2)
    espacos_direita = Integer.floor_div(espacos_total, 2)
